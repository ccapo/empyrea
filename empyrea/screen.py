...
class Screen:
    ...
    def __init__(self, width, height, fullscreen, font, font_type, limit_fps=30):
        ...
        self.wiwindow = libtcod.console_new(
            self.view_width, height - self.view_height - 3)
        self.wswindow = libtcod.console_new(
            width - self.view_width - 3, height - 2)
        self.toplayer = libtcod.console_new(self.view_width, self.view_height)

        self.LoadScreen = libtcod.console_new(
        ...
        self.fontinfo = libtcod.image_load(
            'fonts/fontinfo%s.png' % self.finfomod)
        ...
        # Corner north/east river.
        libtcod.console_map_ascii_code_to_font(233, 7, 6)
        # Corner south/east river.
        libtcod.console_map_ascii_code_to_font(234, 8, 6)
        # Corner south/west river.
        libtcod.console_map_ascii_code_to_font(235, 9, 6)
        # Corner north/west river.
        libtcod.console_map_ascii_code_to_font(236, 10, 6)
