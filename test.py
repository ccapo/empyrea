...
libtcod.console_set_custom_font(
    'fonts/dullard14x14.png', libtcod.FONT_LAYOUT_TCOD, 32, 32)
...
while not libtcod.console_is_window_closed():
    ...
    libtcod.console_print_ex(
        testconsole, 10, 40, libtcod.BKGND_NONE, libtcod.LEFT, '@')
    libtcod.console_print_ex(
        testconsole, 11, 40, libtcod.BKGND_NONE, libtcod.LEFT, chr(146))
    ...
    libtcod.console_print_ex(
        testconsole, 20, 40, libtcod.BKGND_NONE, libtcod.LEFT, 'C')
